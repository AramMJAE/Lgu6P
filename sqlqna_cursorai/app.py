...
if menu == "데이터베이스 정보":
    ...
    # ER 다이어그램 URL
    er_diagram_url = "https://www.mysqltutorial.org/wp-content/uploads/2018/04/MySQL-Sample-Database-Diagram.png"
    st.markdown("<h3 class='mysql-blue'>데이터베이스 ER 다이어그램</h3>", unsafe_allow_html=True)
    st.image(er_diagram_url, caption="classicmodels 데이터베이스 ER 다이어그램", use_column_width=True)
